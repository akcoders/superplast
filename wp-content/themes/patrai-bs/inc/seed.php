...
function patrai_bs_seed_content() {
	...
	$categories = array( 'Cooling Tower Components', 'Water Treatment Technology', 'Building Products', 'PVC Sleeving & Profiles' );
	...
	$products = array(
		...
		array( 'biological-media', 'Biological Media', 'Water Treatment Technology', 'Structured and random media options that provide surface area for attached-growth biological treatment processes.', 'img/products/WaterTechnology/BiologicalMedia/biomedia.jpg', array( 'Fixed and floating media options', 'Application-led surface-area selection', 'Lightweight polymer construction' ) ),
		array( 'floating-media', 'Floating Media', 'Water Treatment Technology', 'Free-moving carrier media for biological processes where protected surface area and mixing are important.', 'img/products/WaterTechnology/BiologicalMedia/productRange/floating-media.jpg', array( 'Multiple carrier geometries', 'High protected surface-area options', 'Suitable for moving-bed process discussions' ) ),
		array( 'settling-media', 'Settling Media', 'Water Treatment Technology', 'Inclined tube and plate media configurations that support compact gravity-separation and clarification systems.', 'img/products/WaterTechnology/SettlingMedia/Settling-Tank01.jpg', array( 'Tube settler module options', 'Efficient settling-area use', 'Modular installation planning' ) ),
		array( 'trickling-filter-media', 'Trickling Filter Media', 'Water Treatment Technology', 'Structured media for attached-growth treatment where air and wastewater need open, repeatable flow paths.', 'img/products/WaterTechnology/trickling-filter.jpg', array( 'Open-flow structure', 'Modular media blocks', 'Application and loading review' ) ),
		array( 'saff-media', 'SAFF Media', 'Water Treatment Technology', 'Submerged aerobic fixed-film media for biological treatment systems requiring stable attached-growth surface.', 'img/products/WaterTechnology/saff.jpg', array( 'Fixed-film process use', 'Lightweight modular blocks', 'Geometry selection based on process needs' ) ),
		array( 'anaerobic-digester-media', 'Anaerobic Digester Media', 'Water Treatment Technology', 'Polymer media solutions for anaerobic attached-growth processes and related wastewater-treatment applications.', 'img/products/WaterTechnology/Anaerobic-Digester.jpg', array( 'Surface for biomass attachment', 'Corrosion-resistant material', 'Application-specific configuration' ) ),
		array( 'fab-reactor-media', 'FAB Reactor Media', 'Water Treatment Technology', 'Fluidized aerobic bioreactor media intended to provide active protected surface area within biological treatment tanks.', 'img/products/WaterTechnology/fab-reactor.jpg', array( 'Moving carrier formats', 'Process-based media quantity review', 'Lightweight polymer construction' ) ),
		array( 'building-products', 'Building Products', 'Building Products', 'uPVC, WPC and FRP solutions for building applications where durability, low maintenance and corrosion resistance matter.', 'img/background/buildingTechnology.jpg', array( 'Alternatives to corrosion-prone materials', 'Low-maintenance polymer products', 'Custom profile development capability' ) ),
		array( 'louvers-fins', 'uPVC Louvers & Fins', 'Building Products', 'Extruded louver and fin profiles for screening, ventilation and building-detail applications.', 'img/products/building/louvers.jpg', array( 'Multiple profile shapes', 'Clean, consistent extruded finish', 'Application-specific lengths and formats' ) ),
		array( 'frp-gratings', 'FRP Gratings', 'Building Products', 'Corrosion-resistant grating panels for industrial access, drainage, platforms and building-service areas.', 'img/products/building/frp-grating-vertical.jpg', array( 'Lightweight panels', 'Corrosion-resistant construction', 'Industrial access and drainage applications' ) ),
		array( 'pvc-profiles', 'PVC Sleeving, Soft & Rigid Profiles', 'PVC Sleeving & Profiles', 'Custom-extruded flexible and rigid PVC profiles developed around dimensional, fit and application requirements.', 'img/home/pvc_sleeving_and_soft_rigid.jpg', array( 'Soft and rigid PVC options', 'Application-led profile development', 'Consistent dimensional and finish focus' ) ),
	);
