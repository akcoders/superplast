...
function patrai_bs_catalog_map() {
	return array(
		...
		'water-technology'    => array( 'slug' => 'water-technology-industry', 'category' => 'Water & Wastewater Technology', 'image' => 'img/background/Water_Wastewater_Technology.jpg' ),
		'biological-media'    => array( 'slug' => 'biological-media', 'category' => 'Water & Wastewater Technology', 'image' => 'img/products/WaterTechnology/BiologicalMedia/biomedia.jpg' ),
		'floating-media'      => array( 'slug' => 'floating-media', 'category' => 'Water & Wastewater Technology', 'image' => 'img/products/WaterTechnology/BiologicalMedia/productRange/floating-media.jpg' ),
		'settling-media'      => array( 'slug' => 'settling-media', 'category' => 'Water & Wastewater Technology', 'image' => 'img/products/WaterTechnology/SettlingMedia/Settling-Tank01.jpg' ),
		'trickling-filter'    => array( 'slug' => 'trickling-filter-media', 'category' => 'Water & Wastewater Technology', 'image' => 'img/products/WaterTechnology/trickling-filter.jpg' ),
		'saff'                => array( 'slug' => 'saff-media', 'category' => 'Water & Wastewater Technology', 'image' => 'img/products/WaterTechnology/saff.jpg' ),
		'anaerobic-digestors' => array( 'slug' => 'anaerobic-digester-media', 'category' => 'Water & Wastewater Technology', 'image' => 'img/products/WaterTechnology/Anaerobic-Digester.jpg' ),
		'fab-reactor'         => array( 'slug' => 'fab-reactor-media', 'category' => 'Water & Wastewater Technology', 'image' => 'img/products/WaterTechnology/fab-reactor.jpg' ),
		'building'            => array( 'slug' => 'building-products', 'category' => 'Building Products & PVC Profiles', 'image' => 'img/background/buildingTechnology.jpg' ),
		'louvers-fins'        => array( 'slug' => 'louvers-fins', 'category' => 'Building Products & PVC Profiles', 'image' => 'img/products/building/louvers.jpg' ),
		'frp-gratings'        => array( 'slug' => 'frp-gratings', 'category' => 'Building Products & PVC Profiles', 'image' => 'img/products/building/frp-grating-vertical.jpg' ),
		'pvc-profiles'        => array( 'slug' => 'pvc-profiles', 'category' => 'Building Products & PVC Profiles', 'image' => 'img/home/pvc_sleeving_and_soft_rigid.jpg' ),
	);
}
